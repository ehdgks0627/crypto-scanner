...
- **[와이어프레임 열기 (htmlpreview)](https://htmlpreview.github.io/?https://github.com/ehdgks0627/crypto-scanner/blob/main/docs/wireframe.html)**
- 백업 링크 (htmlpreview가 느릴 때): [raw.githack 버전](https://raw.githack.com/ehdgks0627/crypto-scanner/main/docs/wireframe.html)
- 로컬에서 보려면 `docs/wireframe.html`을 직접 열면 됩니다.
...
실행 가능한 테스트베드 compose는 [testbed/README.md](testbed/README.md)에 별도로 정리되어 있습니다.

| 파일 | 내용 |
|---|---|
| [00-overview.md](docs/00-overview.md) | 프로젝트 정보, 범위, 결정사항 요약 |
| [01-architecture.md](docs/01-architecture.md) | 컴포넌트 아키텍처, 데이터 흐름, 배포 토폴로지 |
| [02-testbed.md](docs/02-testbed.md) | 테스트베드 서비스/Agent 자산 명세, 의도된 취약점 매트릭스 |
...
| [api/openapi.yaml](docs/api/openapi.yaml) | API 계약의 기계 판독 기준 원본 |
| [api/examples](docs/api/examples) | API request/response 예시 JSON |
...
| [14-ci-cd.md](docs/14-ci-cd.md) | EC2 pull deployer 및 GitHub Actions OIDC 배포 옵션 |

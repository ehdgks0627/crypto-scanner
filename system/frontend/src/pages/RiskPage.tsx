...
export function RiskPage() {
  ...
  if (!selectedSnapshotId) {
    return (
      <Section>
        <PageHeader title="위험평가" />
        <EmptyState title="스냅샷이 없습니다" description="스캔을 실행해 자산 스냅샷을 생성한 뒤 위험평가를 확인할 수 있습니다." />
      </Section>
    );
  }
  return <Navigate to={`/snapshots/${selectedSnapshotId}/risk`} replace />;
}

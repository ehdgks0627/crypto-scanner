...
LLM 정성 분석 요청 (6.6, Mock 응답). 현재 응답은 DHS 6개 기준 중 Q1 `asset_value`, Q2 `protected_information`, Q3 `communication_scope`, Q4 `sharing_level`, Q5 `critical_infrastructure`, Q6 `protection_duration`을 구조화해 포함한다.
